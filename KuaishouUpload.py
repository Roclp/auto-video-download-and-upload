...
class KuaiShouVideo(object):
    ...
    async def upload(self, playwright: Playwright) -> None:
        ...
        # title_selector = ".clGhv3UpdEo-"
        title_selector = "._description_36dct_62"
        ...
        # 点击发布按钮
        # await page.locator(f'xpath=/html/body/div[1]/div[1]/div[1]/main/div/div/div[1]/div/div/haploid-html/haploid-body/div/div/div/div/div[1]/div/div[4]/div/div[4]/div[2]/div[8]/button[1]/span').click()
        # await page.locator('button.ant-btn.ant-btn-primary:has-text("发布")').click()
